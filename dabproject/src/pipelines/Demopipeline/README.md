...
This folder defines all source code for the 'Demopipeline' pipeline:
...
* Take a look at the sample under "sample_users_demopipeline.py" to get familiar with the syntax.
